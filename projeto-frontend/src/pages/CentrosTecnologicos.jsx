...
export default function CentroTecnologicos() {
    ...
    return (
        <>
            <Navbar />
            <div className="text-black pt-32 px-6 sm:px-10 md:px-20 flex flex-col gap-1">
                <span className="text-2xl md:text-3xl font-bold">Centros Tecnológicos</span>
                <span className="text-sm md:text-base">Descubra os principais centros tecnologicos da cidade de São José - SC</span>
            </div>
            <div className="pb-24">
                <div>
                    <div className="px-6 sm:px-10 md:px-20 lg:px-92 mt-12 md:mt-24 border-gray-200">
                        <div className="border-1 hover:shadow-xl transition duration-200 border-gray-100 bg-white shadow-md flex flex-col gap-5 px-6 md:px-10 pb-8 md:pb-10 pt-6 md:pt-8 rounded-2xl">
                            <div className="">
                                <div>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                <div className="w-full md:w-100 h-48 md:h-64 flex-shrink-0">
                            ...
                            <div>
                                <span className="font-light text-sm md:text-base">Endereço: Av. Presidente Kennedy, 815 - Campinas, São José - SC, 88101-001</span>
                            </div>
                            </div>
                            </div>
                        </div>
                                      ...
                                      que aproximam estudantes e a comunidade do universo digital, promovendo
                                       inclusão tecnológica e desenvolvimento de habilidades para o futuro.
                                        O espaço funciona como um ponto de apoio para formação, criatividade
                                         ...
                                         <div>
                                            <span className="font-light text-sm md:text-base">Endereço: R. Bento Águido Viêira, 1463 - Bela Vista, São José - SC, 88110-130</span>
                                         </div>
                            </div>
                            </div>
                        </div>
